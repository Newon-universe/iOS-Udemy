        ...
        ZStack {
            ...
            ZStack {
                ...
                Image("leg")
                    ...
                    .offset(x: -455, y: 90)
                    .animation(
                        .easeInOut(duration: 0.4).delay(1).repeatForever(autoreverses: true),
                        value: leftLeg
                    )
                    .onAppear {
                        leftLeg.toggle()
                ...
                Image("leg")
                    ...
                    .offset(x: -448, y: 92)
                    .animation(
                        .easeInOut(duration: 1).delay(0.09).repeatForever(autoreverses: true),
                        value: rightLeg
                    )
                    .onAppear {
                        rightLeg.toggle()
                ...
                Image("rope")
                    ...
                    .aspectRatio(contentMode: .fit)
                    .mask {
                        LinearGradient(gradient: fadeOutRope, startPoint: .top, endPoint: .bottom)
                    }
            ...
            .rotationEffect(.degrees(girl ? -30 : -48), anchor: .top)
            .animation(
                .easeInOut(duration: 1).delay(0.09).repeatForever(autoreverses: true),
                value: girl)
            .onAppear {
