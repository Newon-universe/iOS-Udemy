...
class CollectionViewController: UICollectionViewController {
    ...
    func setupDataSource() {
        dataSource = .init(collectionView: collectionView) { collectionView, indexPath, item in
            ...
            // now, itemIdentifier in dataSource init, it just returns the actual item.
    ...
    func setupCompositionalLayout() {
        layout = .init() { sectionIndex, env in
            //env means what is divice type, like iPad / iPhone ...
            ...
            case .grid:
                ...
                //MARK: - only when you need a footer
