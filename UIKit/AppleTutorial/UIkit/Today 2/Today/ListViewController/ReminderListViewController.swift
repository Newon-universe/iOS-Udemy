...
class ReminderListViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        // This clouser configures and returns the supplementary header view from the diffable data source.
        ...
        listStyleSegmentedControl.addTarget(self, action: #selector(didChangeListStlye(_:)), for: .valueChanged)
    ...
    override func collectionView(_ collectionView: UICollectionView, shouldSelectItemAt indexPath: IndexPath) -> Bool {
        ...
        return false
        //MARK: - what differnces is false and true ?
    }
    ...
    func pushDetailViewForReminder(withId id: Reminder.ID) {
        ...
        let viewController = ReminderViewController(reminder: reminder) { [weak self] reminder in
            ...
            self?.updateSnapshot(relading: [reminder.id])
        }
        navigationController?.pushViewController(viewController, animated: true)
    }
    
    func showError(_ error: Error) {
        let alertTitle = NSLocalizedString("Error", comment: "Erorr alert title")
