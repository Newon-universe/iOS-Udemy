...
extension ReminderListViewController {
    ...
    func updateSnapshot(relading idsThatChanged: [Reminder.ID] = []) {
    ...
    func prepareReminderStore() {
        // Important: You must call functions marked as async from within a Task or another asynchronous function.
        Task {
            do {
