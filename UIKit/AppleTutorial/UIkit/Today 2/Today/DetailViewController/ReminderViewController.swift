...
class ReminderViewController: UICollectionViewController {
    ...
    // The system calls setEditing(_:animated:) when the user taps the edit or done button.
    ...
    private func section(for indexPath: IndexPath) -> Section {
        ...
        guard let section = Section(rawValue: sectionNumber) else { fatalError("Unalbe to find matching section") }
        return section
    }
}
