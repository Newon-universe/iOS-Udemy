...
enum TodayError: LocalizedError {
    ...
    // Because LocalizedError provides a deafult implementation, you're not required to implement this property.
    ...
    var errorDescription: String? {
        ...
        case .reminderHasNoDueDate:
            return NSLocalizedString("A reminder has no due date.", comment: "reminder has no de date error description.")
        case .unknown:
