...
public enum CommonModuleAsset {
  public static let accentColor = CommonModuleColors(name: "AccentColor")
...
public final class CommonModuleColors {
...
public extension CommonModuleColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, *)
  convenience init?(asset: CommonModuleColors) {
